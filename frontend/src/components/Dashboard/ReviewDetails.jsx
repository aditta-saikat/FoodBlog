...
import { 
  Heart, MessageCircle, Share2, Edit, Trash2, Star, 
  ChevronLeft, ChevronRight, ArrowLeft, Calendar, MapPin, X 
} from 'lucide-react';
import { getBlogById } from '../../lib/api/Blog';
import { createComment, deleteComment } from '../../lib/api/Comment';
import { toggleLike, getLikesCount, hasLiked, getUsersWhoLiked } from '../../lib/api/Like';
  ...
  const StarRating = ({ rating }) => {
    return (
      <div className="flex items-center">
        ...
        <span className="ml-2 text-lg font-medium text-gray-700">{rating.toFixed(1)}</span>
      </div>
    );
  };
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="relative bg-gray-900 h-96">
            {review.images && review.images.length > 0 ? (
              <>
                <img
                  src={review.images[currentImageIndex] || '/api/placeholder/800/400'}
          ...
          <div className="p-6">
            <div className="mb-4 flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center text-gray-600 mb-2">
                  <span className="font-medium text-lg text-gray-800">{review.restaurant}</span>
                  {review.location && (
                    <>
            ...
            <div className="flex items-center mb-6">
              ...
              />
              <div>
                <div className="font-medium text-gray-800">{review.author.username}</div>
            ...
            <div className="prose max-w-none mb-6">
              <p className={showFullContent ? '' : 'line-clamp-6'}>
                {review.content}
              </p>
              ...
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <Heart
                      size={20}
                      className={hasUserLiked ? 'fill-red-500 text-red-500' : ''}
                    />
                  </button>
                  <button
                ...
                <div className="space-y-4">
                  {comments.map(comment => (
                    <div key={comment._id} className="flex space-x-3">
                      <img
                        src={comment.userId?.avatarUrl || '/api/placeholder/40/40'}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-gray-800">Users Who Liked</h3>
              <button
            ...
            {usersWhoLiked.length > 0 ? (
              ...
              <p className="text-gray-500">No users have liked this review yet.</p>
            )}
          </div>
        </div>
      )}
